                ...
                <ul class="slides">
                    <li>
                        <div class="super-hero-unit">
                            <figure>
                                <img alt="some image" src="/static/img/assets/landscapes/landscape-2-1250x420.jpg">
                    ...
                    <li>
                        <div class="super-hero-unit">
                            <figure>
                                <img alt="some image" src="/static/img/assets/landscapes/landscape-3-1250x420.jpg">
                                <figcaption class="flex-caption">
                                    <h1 class="super">
                                        Creative
                                        <span class="lighter">
                    ...
                    <li>
                        <div class="super-hero-unit">
                            <figure>
                                <img alt="some image" src="/static/img/assets/landscapes/landscape-1-1250x420.jpg">
                                <figcaption class="flex-caption">
                                    <h1 class="super">
                                        Adaptive
                                        <span class="lighter">
            ...
            <div class="row-fluid">
                ...
                <ul class="unstyled row-fluid">
                  ...
                  <span class="box-inner">
                    <img alt="some image" class="img-circle" src="/static/img/assets/landscapes/landscape-2-a-300x300.jpg">
                    ...
                    <li class="span3">
                        <div class="round-box round-medium">
                  <span class="box-inner">
                    <img alt="some image" class="img-circle" src="/static/img/assets/landscapes/landscape-2-b-300x300.jpg">
                    <i class="icon-aws"></i>
                  </span>
                        </div>
                    ...
                    <li class="span3">
                        <div class="round-box round-medium">
                  <span class="box-inner">
                    <img alt="some image" class="img-circle" src="/static/img/assets/landscapes/landscape-2-c-300x300.jpg">
                    ...
                    <li class="span3">
                        <div class="round-box round-medium">
                  <span class="box-inner">
                    <img alt="some image" class="img-circle" src="/static/img/assets/landscapes/landscape-2-d-300x300.jpg">
                    <i class="icon-cog"></i>
                  </span>
                        </div>
            ...
            <div class="row-fluid">
                <div class="span6">
                    <div class="flexslider margin-bottom" data-flex-directions="hide" data-flex-speed="10000" id="work">
                        <ul class="slides">
                            <li>
                                <img alt="some image" src="/static/img/assets/devices/imac-2.png">
                            </li>
                            <li>
                                <img alt="some image" src="/static/img/assets/devices/macbook.png">
                            </li>
                            <li>
                                <img alt="some image" src="/static/img/assets/devices/ipad.png">
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="span4">
                            <div class="round-box box-small">
                                <a class="box-inner" href="post.html">
                                    <img alt="some image" class="img-circle" src="/static/img/assets/landscapes/landscape-3-300x300.jpg">
                                </a>
                            </div>
                ...
                <li class="span4">
                    <div class="row-fluid">
                        <div class="span4">
                            <div class="round-box box-small">
                                <a class="box-inner" href="post.html">
                                    <img alt="some image" class="img-circle" src="/static/img/assets/landscapes/landscape-1-300x300.jpg">
                                    <i class="icon-link"></i>
                                </a>
                            </div>
                            <h5 class="text-center light">
                ...
                <li class="span4">
                    <div class="row-fluid">
                        <div class="span4">
                            <div class="round-box box-small">
                                <a class="box-inner" href="post.html">
                                    <img alt="some image" class="img-circle" src="/static/img/assets/landscapes/landscape-2-e-300x300.jpg">
                                    <i class="icon-play"></i>
                                </a>
                            </div>
                            <h5 class="text-center light">
        ...
        <div class="container-fluid">
            ...
            <div class="flexslider fadein-links" data-flex-animation="slide" data-flex-controls="hide" data-flex-directions-position="outside" data-flex-directions-type="fancy" data-flex-itemwidth="250" data-flex-slideshow="false" id="client">
                <ul class="slides">
                    <li>
                        <a href="#">
                            <img alt="client" src="/static/img/assets/clients/client1.png">
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img alt="client" src="/static/img/assets/clients/client2.png">
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img alt="client" src="/static/img/assets/clients/client3.png">
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img alt="client" src="/static/img/assets/clients/client4.png">
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img alt="client" src="/static/img/assets/clients/client5.png">
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img alt="client" src="/static/img/assets/clients/client6.png">
                        </a>
                    </li>
                    <li>
                        <a href="#">
                            <img alt="client" src="/static/img/assets/clients/client7.png">
                        </a>
                    </li>
                    <li>
                        <a href="#">
